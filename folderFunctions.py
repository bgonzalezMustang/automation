...
#iterated through all files in a folder, creates text file with number of files called "!LOG_FILE-"
...
#function for verifyight that the number of files in a folder is equal to the number of files declared by the log file
